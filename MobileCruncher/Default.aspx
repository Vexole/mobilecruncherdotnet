...
<div class="d-flex flex-column align-items-center pt-5">
  ...
  <div class="d-flex flex-column align-items-center pt-5">
    ...
    <div class="d-flex justify-content-center flex-wrap">
      <div class="card col-md-4 mt-4 me-4 benefits-item">
        <div class="card-body">
      ...
      <div class="card col-md-4 mt-4 me-4 benefits-item">
        <div class="card-body">
          ...
          <p class="card-text mc-color-gray text-center">Free shipping on all of your orders.</p>
        </div>
      </div>
      <div class="card col-md-4 mt-4 me-4 benefits-item">
        <div class="card-body">
  ...
  <div class="d-flex flex-column align-items-center pt-5 pb-5">
    ...
    <div class="d-flex justify-content-center flex-wrap">
      <div class="card col-md-2 me-4 mt-3 testimonials-item">
