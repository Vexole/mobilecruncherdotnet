<%@ Page Title="MobileCrunchers - Dashboard" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="MobileCruncher.Dashboard" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h4 class="text-center mc-color-secondary">Change here</h4>
    <div class="d-flex mt-3 mx-auto justify-content-center">
        <asp:GridView ID="grdViewProducts" runat="server" DataSourceID="sqlDSProductsList" AutoGenerateColumns="False" DataKeyNames="Id" CssClass="me-4" CellPadding="4" ForeColor="#333333" GridLines="None">
    ...
    <h4 class="text-center mt-3 mc-color-secondary">Change here</h4>
    <div class="d-flex mt-3 mx-auto justify-content-center">
    ...
    <h4 class="text-center mt-3 mc-color-secondary">Change here</h4>
    <div class="d-flex mt-3 mx-auto justify-content-center">
        <asp:GridView ID="grdViewProcessorTypes" runat="server" AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="sqlDSProcessorTypes" ShowFooter="True" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3">
            <Columns>
                <asp:TemplateField HeaderText="Id" InsertVisible="False" SortExpression="id">
                    <EditItemTemplate>
                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("id") %>'></asp:Label>
